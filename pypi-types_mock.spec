...
Source0  : https://files.pythonhosted.org/packages/96/0b/98191da8bb9af6b62f90669d34f46f9a139614603234ad897e8a60c2346f/types-mock-5.0.0.2.tar.gz
...
%prep
%setup -q -n types-mock-5.0.0.2
cd %{_builddir}/types-mock-5.0.0.2
pushd ..
cp -a types-mock-5.0.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674150149
