...
Source0  : https://files.pythonhosted.org/packages/36/40/1ed5b983c97161ad1605de42932143bcb24f5e435cc660de4487f78f6a4c/types-mock-5.1.0.20240425.tar.gz
...
%prep
%setup -q -n types-mock-5.1.0.20240425
cd %{_builddir}/types-mock-5.1.0.20240425
pushd ..
cp -a types-mock-5.1.0.20240425 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714061191
